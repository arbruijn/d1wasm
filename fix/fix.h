...
inline fix fixmul(fix a,fix b) { return (int32_t)(((int64_t)a * (int64_t)b) >> 16); }

inline fix fixdiv(fix a,fix b) { return (int32_t)((((int64_t)a) << 16) / b); }

inline fix fixmuldiv(fix a,fix b,fix c) { return (int32_t)(((int64_t)a * (int64_t)b) / c); }
