...
//	mprintf( (0, "CCT: %.1f\n", f2fl(controlcen->Timer)));
	...
	if (fc > 16)
		fc = 16;
	ConsoleObject->mtype.phys_info.rotvel.x += fixmul(psrand() - 16384, 3*F1_0/16 + (F1_0*(16-fc))/32);
	ConsoleObject->mtype.phys_info.rotvel.z += fixmul(psrand() - 16384, 3*F1_0/16 + (F1_0*(16-fc))/32);
