...
extern int load_filenames(char *buf, int fnsize, int fnmax, const char *filespec, int stripext);
...
ReadFileNames:
	...
	mprintf((0, "list: %s\n", filespec));
	NumFiles += load_filenames(filenames + NumFiles * 14, 14, MAX_FILES - NumFiles, filespec, player_mode);
