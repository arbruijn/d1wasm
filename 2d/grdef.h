...
void gr_linear_movsb( void * source, void * dest, unsigned int nbytes);
void gr_linear_movsw( void * source, void * dest, unsigned int nbytes);
void gr_linear_movsd( void * source, void * dest, unsigned int nbytes);
