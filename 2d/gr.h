...
typedef struct _grs_font_disc {
	...
	int 	ft_data;			// Ptr to raw data.
	int	ft_chars;		// Ptrs to data for each char (required for prop font)
	int	ft_widths;		// Array of widths (required for prop font)
	int  ft_kerndata;	// Array of kerning triplet data
} grs_font_disc;
